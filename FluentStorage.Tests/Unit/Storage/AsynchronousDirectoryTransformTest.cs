...
/// <summary>
/// provides a test method to read a previously encrypted and gzipped file saved in blob strage in an asynchronous manner
/// </summary>
public class AsynchronousDirectoryTransformTest : AsynchronousSinksTest {
	public AsynchronousDirectoryTransformTest() : base(
		StorageFactory
